        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1 flex justify-center animate-fade-in">
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-accent rounded-full blur-2xl opacity-30 animate-glow" />
              <img
                ...
                className="relative w-80 h-80 rounded-full object-cover border-4 border-white/20 shadow-elegant hover:scale-105 transition-all duration-300"
              />
            </div>
          </div>
          ...
          <div className="order-1 lg:order-2 text-center lg:text-left animate-fade-in">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl animate-fade-in-delay">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start items-center mb-12 animate-fade-in-delay">
            ...
            <div className="flex justify-center lg:justify-start space-x-6 animate-fade-in-delay">
